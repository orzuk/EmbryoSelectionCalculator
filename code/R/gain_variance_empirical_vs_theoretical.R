...
var.th <- gain.moments(ns, 1, 'approx', 1)$Var.G * sigma.z^2 * r2ps # asymptotic approximation
var.num <- gain.moments(ns, 1, 'exact', 1)$Var.G * sigma.z^2 * r2ps # numeric integral
